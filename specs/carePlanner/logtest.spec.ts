...
describe('Verify the Patient Header has accurate Patient and Visit information', () => {
        ...
        beforeAll(() => {
            browser.logger.info("***********Before all Testing***********");
        ...
        it('Set up data for Executing Test case ', async () => {
            browser.logger.info("Test this functionality when not working...............");
           browser.sleep(3000);
           browser.logger.info("*********** Executing Tests ***********");
           let careplannerapicalls = new CarePlannerApiCalls();
           await careplannerapicalls.CreateClientPetAddProduct();
        });
