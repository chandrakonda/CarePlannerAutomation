...
export class Utils {
    ...
    static compressFolder(folderName, destinationFolderName, comparessedFileName, compressFileExtn) {
        try {
    ...
    static composeMailContentFromTestResult(testEnvironment) {
        try {
            let __hospitalId = TestBase.GlobalData.EnvironmentConfigDetails.hospitalid;
            let __serverName = TestBase.GlobalData.EnvironmentConfigDetails.servername;
            let __applicationURL = TestBase.GlobalData.EnvironmentConfigDetails.applicationurl;
            let __apiEndPoint = TestBase.GlobalData.EnvironmentConfigDetails.wwapiendpoint;
            let __userName = TestBase.GlobalData.EnvironmentConfigDetails.username;
    ...
    static sendEmail(testExecutionInfo, testReportFilePath, testReportFileName) {
        try {
    ...
    static setBrowserConfigurations() {
        try {
